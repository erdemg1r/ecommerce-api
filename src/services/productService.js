...
export const productService = {
    ...
    findAllWithCursor: async (filters) => {
        const where = buildProductWhere(filters);
    ...
    update: async (id, input) => {
        ...
        if (input.producerId !== undefined)
            data.producerId = input.producerId;
    ...
    addTags: async (productId, tagIds) => {
        return prisma.product.update({
            where: { id: productId },
            data: {
    ...
    removeTags: async (productId, tagIds) => {
        return prisma.product.update({
            where: { id: productId },
            data: {
    ...
    setTags: async (productId, tagIds) => {
        return prisma.product.update({
            where: { id: productId },
            data: {
